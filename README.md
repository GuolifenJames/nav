<p align="center">
  <a href="https://nav3.cn/?g">
    <img src="https://qiniu.image.tuotuoquan.com/sun_code/20250421173213-oBEnRe-logo.png" width="130" />
  </a>
  <br />
  <b>发现导航</b>
  ...
  <p align="center">
    ...
    <a href="http://www.ordosai.com/stargazers"><img src="https://img.shields.io/github/stars/xjh22222228/nav" alt="Stars"/></a>
...
3、https://github.com/GuolifenJames/nav/settings/secrets/actions 添加申请的 token， name 填写 `TOKEN` 大写。
...
|√ | | imageRepoUrl | 图片仓库, 默认主仓库 `https://github.com/GuolifenJames/image?branch=main` |

## 后台

将路由地址修改为 `system` 即可进入，如: http://nav.ordosai.com 修改为 http://nav.ordosai.com/system
