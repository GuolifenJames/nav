...
export function writeSEO(webs: INavProps[], payload: SEOPayload): string {
  ...
  let seoTemplate = `
<div data-url="http://www.ordosai.com" data-server-time="${Date.now()}" data-a="x.i.e-jiahe" data-date="${nowDate}" id="META-NAV" style="z-index:-1;position:fixed;top:-10000vh;left:-10000vh;">
`
